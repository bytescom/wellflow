                ...
                <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                    <div className="space-y-8">
                        <div className="space-y-6">
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-200 rounded-full text-sm font-medium text-emerald-700">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 mt-4">
                            <button className="flex items-center justify-center gap-2 px-6 py-4 text-base font-medium text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 rounded-md shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer">
                                Start Creating Free
                                <FaArrowRight className="h-4 w-4" />
                            </button>
                            <button className="px-6 py-4 text-base font-medium text-gray-700 border border-gray-300 bg-white hover:bg-gray-100 hover:border-gray-400 rounded-md transition duration-200 cursor-pointer">
                                Explore Sessions
                            </button>
                        </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-white rounded-3xl shadow-2xl shadow-gray-900/10 p-3 sm:p-5 border border-gray-100">
                            <div className="relative w-full h-100 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-2xl flex items-center justify-center overflow-hidden">
                                <Image
